...
append using "${data}\simulation_results_s2_gov_specific.dta" "${data}\simulation_results_s3_national.dta" "${data}\simulation_results_s3_gov_specific.dta" "${data}\simulation_results_s6_national.dta" "${data}\simulation_results_s6_gov_specific.dta", gen(scenario)
